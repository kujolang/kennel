...
my-tool = "main.kujo"</code></pre><p>Entries must be included .kujo files. Historical packages may use their existing [kujo].entry instead. Libraries with no executable entry are installed with kennel add.</p>'''
