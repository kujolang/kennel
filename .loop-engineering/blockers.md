...
blockers:
  - id: kujo-cli-module-distribution
    ...
    evidence: "Kennel retains its local CLI parser because external repositories cannot resolve kujo/modules/cli.kujo through the current module search paths; copying the module would create a second source of truth."
